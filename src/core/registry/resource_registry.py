...
uses that same document's R0-R3 classes.
...
class ResourceRegistry:
    ...
    def register(self, resource: Resource) -> None:
        ...
        emit_registry_event(self._events, "registry.resource.registered", resource.resource_id)
    ...
    def update(self, resource: Resource) -> None:
        ...
        emit_registry_event(self._events, "registry.resource.updated", resource.resource_id)

    def delete(self, resource_id: str) -> None:
        self._repo.delete(resource_id)
        emit_registry_event(self._events, "registry.resource.deleted", resource_id)
